...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,       KC_B,    KC_ENT, _______,  _______, _______, _______, _______, _______, _______, \
      SWAPFX,    KC_ESC,  KC_LALT, KC_LGUI, FUNCTION,   SWAP,    KC_SPC, _______,  _______, _______, _______, _______, _______, _______ \
    ),
  /* SWAP
   * ,-----------------------------------------.
   * | Del  |   6  |   7  |   8  |   9  |   0  |
   ...
   */
  [_SWAP] = LAYOUT( \
      KC_DEL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,                      _______, _______, _______, _______, _______, _______, \
      KC_BSPC, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,                      _______, _______, _______, _______, _______, _______, \
      KC_LCTL, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,                   _______, _______, _______, _______, _______, _______, \
      KC_LSFT, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_QUOT, _______, _______, _______, _______, _______, _______, _______, \
      _______, KC_QUOT, KC_LALT, KC_LGUI, _______, _______, KC_PIPE, _______, _______, _______, _______, _______, _______, _______ \
      ),
  ...
  [_FUNCTION] = LAYOUT( \
      ...
      _______, KC_Q,    KC_UP,   KC_E,    KC_HOME, KC_PGUP,                   _______, _______, _______, _______, _______, _______, \
      KC_LCTL, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  KC_PGDN,                   _______, _______, _______, _______, _______, _______, \
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    _______, _______, _______, _______, _______, _______, _______, _______, _______, \

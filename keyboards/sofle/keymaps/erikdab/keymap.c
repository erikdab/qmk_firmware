 ...
 */
  [_ADJUST] = LAYOUT( \
  XXXXXXX , XXXXXXX,KC_STENO ,  XXXXXXX , XXXXXXX, XXXXXXX,                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
 ...
 */
  [_STENO] = LAYOUT( \
  KC_QWERTY, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
  ...
  KC_DEL   , KC_A,    KC_S,    KC_D,    KC_F,    KC_G,     XXXXXXX, XXXXXXX,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
             XXXXXXX, XXXXXXX, KC_C,    KC_V,    KC_SPC,                      KC_ENT , KC_N,    KC_M,    XXXXXXX, XXXXXXX \
  )
};
